        ...
        <div class="container py-4 py-md-5 px-4 px-md-3 text-body-secondary">
          <div class="row">
            ...
            <div class="col-6 col-lg-2 mb-3">
              ...
              <ul class="list-unstyled">
                <li class="mb-2">
                  <a href="https://github.com/twbs/bootstrap" rel="noopener">
                    Bootstrap 5
                  </a>
                </li>
                <li class="mb-2">
                ...
                <li class="mb-2">
                  <a href="https://github.com/twbs/icons" rel="noopener">
                    Icons
                  </a>
                </li>
                <li class="mb-2">
                  <a href="https://github.com/twbs/rfs" rel="noopener">
                    RFS
                  </a>
                </li>
                <li class="mb-2">
                  <a href="https://github.com/twbs/examples/" rel="noopener">
                    Examples repo
                  </a>
                </li>
              </ul>
            ...
            <div class="col-6 col-lg-2 mb-3">
              ...
              <ul class="list-unstyled">
                ...
                <li class="mb-2">
                  <a href="https://github.com/sponsors/twbs" rel="noopener">
                    Corporate sponsors
                  </a>
                </li>
                <li class="mb-2">
                  <a href="https://opencollective.com/bootstrap" rel="noopener">
                    Open Collective
                  </a>
                </li>
                <li class="mb-2">
